    ...
    <main className="mx-auto max-w-4xl px-6 py-16">
      <div className="space-y-5">
        ...
        <p className="leading-7 text-muted-foreground">
          ...
          precisam construir plataformas web, sistemas internos, dashboards e
          produtos SaaS com visão de longo prazo.
        </p>
      </div>
      ...
      <section className="mt-10 grid gap-4 rounded-[2rem] border border-border p-6">
        ...
        <p className="leading-7 text-muted-foreground">
          Plataformas para educação, operações, atendimento, relatórios, gestão
          interna, marketplace, áreas de cliente e fluxos de negócio que
          precisam de segurança, performance e facilidade de evolução.
        </p>
        <p className="leading-7 text-muted-foreground">
          Também estruturamos SEO técnico, áreas públicas e páginas de aquisição
          quando o produto exige crescimento orgânico.
        </p>
      </section>
    </main>
  );
